...
from scripts import get_names_photos, send_to_telegram
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Программа публикует картинки из в канал телеграм-канал.")
