...
def fetch_nasa_planetary_apod_picture(api_key, amount):
    ...
    filtered_information = [
        dictionary
        for dictionary in photos_information
        if dictionary["media_type"] != "other" and find_image_format(dictionary["url"])
    ]
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Программа скачивает фотографии космоса с сайта NASA")
